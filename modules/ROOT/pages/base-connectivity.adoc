...
Learn how to generate the base connectivity for your connector. Base connectivity is the foundation of your connector and it defines the basic structure of your connector. test

The base connectivity includes:

* `{projectname}-connectivity-model` 
+
This package contains the code that directly reflects the structure of the API specification from which a project is generated. This is written in LinkWeave, and is the base from which all connectors will be built.
...
+
NOTE: Connector Builder has been tested with `claude-sonnet-4`. Performance and accuracy with other models isn't guaranteed.
. Click *Send*.
