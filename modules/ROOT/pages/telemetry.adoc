...
Connector Builder can send a small amount of usage telemetry that helps improve the product. Telemetry helps Salesforce understand which features are most useful and where to invest. It's limited to product-usage signals and doesn't collect the content you work on.
