...
Learn how to test your connector. Testing is an important part of the development process, and it helps you ensure that your connector works as expected. Testing your connector involves generating tests and running tests.
...
=== Generate Test Data With AI Assistance (Cursor)
