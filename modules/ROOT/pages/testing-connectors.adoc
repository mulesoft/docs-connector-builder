...
Learn how to test your connectors. Testing is an important part of the development process, and it helps you ensure that your connectors work as expected. Testing your connectors involves generating tests and running tests.
...
This generates connectivity model tests, which are split into data files and actual test files, creating a structured project. These tests include:
...
NOTE: Connector Builder generates tests for all connection types. You must manually delete unwanted connections from `ConnectionOperations.dwl`.
