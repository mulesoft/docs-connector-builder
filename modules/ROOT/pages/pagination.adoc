...
. Open the Cursor chat window (if not already open) and paste the copied prompt. Ensure you're in Ask mode. If the API documentation or API spec isn't already included in the prompt, provide it now.
+
