...
+
If you want to execute an operation, you'll need your connection profile ID. Use the `uc_list_connection_profiles` MCP tool first to xref:connections.adoc#list-connection-profiles-with-mcp-tools[list connection profiles] to retrieve the ID.
