...
Connectors built with UC Builder can support:
...
After you create your connector, you can xref:testing-a-connector.adoc[test], xref:packaging-a-connector.adoc[package], xref:releasing-a-connector.adoc[release], and xref:running-a-connector.adoc[run] your connector. 

== Use Cases

Use UC Builder to create a wide range of connectors. Some use cases include:
